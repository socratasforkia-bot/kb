...
def page_directions():
    ...
    with c1:
        ...
        # ① 경복궁역: 지하철역 자체
        station_lat = 37.57583
        station_lon = 126.97361

        # ② 경복궁역 3번출구 버스정류장
        # 정류소 번호: 100000020 / 데이터 라인 연계 ID: 100000021
        # 제공받은 정류장 좌표(Y, X)를 그대로 사용
        bus_stop_lat = 37.577040144
        bus_stop_lon = 126.9721994292
        ...
        # ③ 경복궁역 3번출구 버스정류장 정확한 위치
        folium.Marker(
            [37.577040, 126.972199],
            tooltip="경복궁역3번출구 버스정류장",
            popup=folium.Popup(
                "<b>경복궁역3번출구 버스정류장</b><br>정류소 번호: 100000020<br>데이터 라인 연계 ID: 100000021",
                max_width=300,
            ),
            icon=folium.Icon(
                color="green",

...
.bk-pass-emblem {{ width:128px; height:128px; object-fit:contain; display:block; margin:0 auto 8px; position:relative; z-index:2; }}
...
@media (max-width:600px) {{ .bk-pass-wrap {{max-width:100%;}} .bk-pass-top {{padding:24px 18px 21px;}} .bk-pass-emblem {{width:105px;height:105px;}} .bk-pass-title-main {{font-size:36px;letter-spacing:6px;text-indent:6px;}} .bk-pass-bottom {{grid-template-columns:1fr 1px 72px;gap:12px;padding:20px 18px;}} .bk-pass-date-num {{font-size:34px;}} }}
</style>
"""
...
def page_visitor_pass():
    ...
    if is_member:
        ...
        st.markdown('<div class="bk-card bk-pass-register">', unsafe_allow_html=True)
